...
from make_env import make_env_world1, make_env_world2_land, make_env_world3, NOOP_JITTER
...
def main():
    ...
    factory = {"w1": make_env_world1, "w2": make_env_world2_land, "w3": make_env_world3}[world]
